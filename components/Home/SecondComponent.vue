...
.resim2{  background-image: url("~/assets/images/imagsses.jpg");   background-size: cover;
    background-position: center;
    background-repeat: no-repeat;
    height: 600px;
    width: 50%;
...
.resim3{  background-image: url("~/assets/images/IMG_4377.jpg");   background-size: cover;
    background-position: center;
    background-repeat: no-repeat;
    height: 600px;
    width: 50%;
